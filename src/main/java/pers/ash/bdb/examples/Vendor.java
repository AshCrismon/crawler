...
public class Vendor implements Serializable{
	...
	private static final long serialVersionUID = 1543188205627472132L;
	...
	public String toString() {
		return "Vendor [repName=" + repName + ", address=" + address
				+ ", city=" + city + ", state=" + state + ", zipcode="
				+ zipcode + ", bizPhoneNumber=" + bizPhoneNumber
				+ ", repPhoneNumber=" + repPhoneNumber + ", vendor=" + vendor
				+ "]";
	}
